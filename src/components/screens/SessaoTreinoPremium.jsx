    ...
    <AnimatePresence mode="wait">
      ...
      {!isTraining && (
        ...
        >
          ...
          >
            ...
            <div className="relative -mx-6 pb-6 overflow-hidden">
              <Swiper
                effect={'coverflow'}
                grabCursor={true}
                centeredSlides={true}
      ...
      {isTraining && (
        ...
        >
          ...
          <motion.div
            className="flex items-center justify-between bg-neutral-900/60 backdrop-blur-xl border border-white/5 rounded-2xl px-4 py-3 sticky top-0 z-30"
