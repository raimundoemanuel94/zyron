    ...
    <div className="min-h-screen bg-neutral-950 text-slate-100 font-sans p-6 selection:bg-yellow-400 selection:text-black">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <header className="relative flex justify-between items-center mb-10 overflow-hidden bg-[linear-gradient(135deg,rgba(12,5,5,1)_0%,rgba(8,4,4,1)_100%)] backdrop-blur-md p-6 rounded-3xl border border-red-500/25 shadow-[0_0_60px_rgba(220,38,38,0.12),inset_0_1px_0_rgba(255,255,255,0.04)]">
          ...
          {/* Linha neon top */}
          <div className="absolute top-0 left-0 w-full h-[1.5px] bg-gradient-to-r from-transparent via-red-500/60 to-transparent pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          >
            <div className="absolute top-0 left-0 w-full h-[1.5px] bg-gradient-to-r from-transparent via-yellow-400/70 to-transparent pointer-events-none" />
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-yellow-400/25 to-transparent pointer-events-none" />
